...
sub read_loader {
    my ($name) = @_;
    $name = find_file ("$ENV{HOME}/pintos/src/userprog/build/loader.bin") if !defined $name; # hw3
    # $name = find_file ("$ENV{HOME}/pintos/src/threads/build/loader.bin") if !defined $name;
